...
public class Reg extends JDialog implements ActionListener {
	...
	public Reg(JDialog f, int bsx, int bsy) {
		...
		orszag.setBounds(144, 296, 176, 22);
		...
		dateadd.setBounds(341, 229, 150, 20);
